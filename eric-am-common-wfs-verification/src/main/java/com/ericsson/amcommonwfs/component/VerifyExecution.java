...
public class VerifyExecution {
    ...
    public String getDefinitionKey(final DelegateExecution execution) {
        ExecutionEntity executionEntity = (ExecutionEntity) execution.getProcessInstance().getSuperExecution();
