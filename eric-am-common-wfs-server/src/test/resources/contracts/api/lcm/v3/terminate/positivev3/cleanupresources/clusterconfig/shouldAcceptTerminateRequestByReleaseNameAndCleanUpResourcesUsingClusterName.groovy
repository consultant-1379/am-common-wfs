 ...
 ******************************************************************************/
package contracts.api.lcm.v3.terminate.positivev3.cleanupresources.clusterconfig
...
when:
  the release name is valid with a valid cleanUpResources query parameter and a valid cluster name
then:
...
"""
    ...
    request {
        ...
        urlPath($(regex("/api/lcm/v3/resources/[a-z]([-a-z0-9]*[a-z0-9])?/terminate"))) {
            queryParameters {
                parameter 'cleanUpResources': 'true'
