...
Contract.make {
    description("""
Represents a successful scenario of scaling an application with a values.yaml and config file

```
given:
  client requests to scale a resource with a values.yaml and cluster01.config files
when:
