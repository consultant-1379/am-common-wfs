...
Contract.make {
    description("""
Represents a successful scenario of upgrading an Application

```
given:
  client requests to perform an upgrade
when:
  valid upgrade request submitted with a valid cluster name
then:
