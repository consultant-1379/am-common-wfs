 ...
 ******************************************************************************/
package contracts.api.lcm.v3.terminate.negative.invalidreleasename.nullcleanupresources
...
when:
  the release name is invalid and the cleanUpResources query parameter is null with a valid applicationTimeOut query parameter
then:
