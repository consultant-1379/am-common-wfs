...
Contract.make {
    description("""
Represents an unsuccessful scenario of upgrading an application with an invalid values.yaml file

```
given:
  client requests to upgrade a resource
when:
  an upgrade request with an invalid values.yaml file is submitted
then:
...
""")
    request {
        ...
        multipart(
                json: $(c(nonEmpty()), p('{"namespace" : "invalid-values", ' +
