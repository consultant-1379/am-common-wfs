    ...
    request {
        ...
        urlPath($(regex("/api/lcm/v3/resources/[a-z]([-a-z0-9]*[a-z0-9])?/terminate"))) {
            queryParameters {
                ...
                parameter 'namespace': value(consumer(regex(nonEmpty())), producer("my-namespace"))
                parameter 'helmClientVersion': value(consumer(regex(nonEmpty())), producer("3.10"))
            }
        }
        multipart(
                clusterConfig: named(
