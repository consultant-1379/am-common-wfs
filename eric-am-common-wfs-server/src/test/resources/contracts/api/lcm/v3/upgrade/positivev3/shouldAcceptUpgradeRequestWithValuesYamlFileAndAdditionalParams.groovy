...
Contract.make {
  description("""
Represents a successful scenario of upgrading an application with a values.yaml file and individual parameters

```
given:
  client requests to upgrade a resource with a values.yaml file and individual parameters
when:
