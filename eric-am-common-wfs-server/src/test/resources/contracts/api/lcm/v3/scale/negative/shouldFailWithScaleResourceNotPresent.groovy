...
when:
  an invalid scale request submitted with missing scale request
then:
...
""")
    request {
        ...
        body(
                """
                {
                  "chartUrl": "https://arm.rnd.ki.sw.ericssonse/artifactory/proj-adp-spider-team-helm/spider-app/spider-app-2.74.8.tgz",
