...
Contract.make {
    description("""
Represents an unsuccessful scenario of instantiating an application with a values.yaml and config file

```
given:
  client requests to instantiate a resource with a values.yaml and cluster01.config files
when:
