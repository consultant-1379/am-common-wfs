...
import com.ericsson.amcommonwfs.camunda.service.WorkflowInstanceServiceCamundaImpl;
...
public abstract class PositiveV3Base {

    @MockBean
    WorkflowInstanceServiceCamundaImpl workflowInstanceServiceCamunda;
    ...
    @BeforeEach
    public void setup() {
        doNothing().when(camundaFileRepository).save(any(), any(byte[].class), anyLong());
