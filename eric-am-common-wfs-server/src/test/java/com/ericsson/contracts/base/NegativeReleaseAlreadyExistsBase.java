...
public class NegativeReleaseAlreadyExistsBase {
    ...
    public WorkflowQueryResponse getWorkflowQueryResponseError() {
        ...
        resourceProcessInstance.setReleaseName("existing-release");
        ...
        resourceProcessInstance.setMessage(
                "{\"detail\":\"A resource named existing-release already exists. Please use a different name or "
                        + "delete the resource with this name.\",\"status\":\"422\"}");
