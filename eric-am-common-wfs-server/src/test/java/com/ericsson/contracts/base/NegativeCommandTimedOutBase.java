...
public class NegativeCommandTimedOutBase {
    ...
    public WorkflowQueryResponse getWorkflowQueryResponseError() {
        ...
        resourceProcessInstance.setReleaseName("release-cmdtimeout");
        ...
        resourceProcessInstance
                .setMessage("{\"detail\":\"Unable to get the result in the time specified\",\"status\":\"422\"}");
