...
@Component
@Slf4j
public class CheckReleaseResourcesExists extends CheckForResourcesBase {

    @Autowired
    public CheckReleaseResourcesExists(ClusterFileUtils clusterFileUtils, GetPods getPods) {
    ...
    protected V1PodList getPodsInNamespace(String releaseName, String namespace, String clusterConfig,
        ...
        return getPods.getPodsWithNamespace(namespace, clusterConfig, releaseName, applicationTimeOut);
    }

    @Override
    protected V1PodList getPodsInAllNamespaces(String releaseName, String clusterConfig,
                                               int applicationTimeOut) throws IOException, ApiException {
        return getPods.getPodsInAllNamespaces(clusterConfig, releaseName, applicationTimeOut);
    }
